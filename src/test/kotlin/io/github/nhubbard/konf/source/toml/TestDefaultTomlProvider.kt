...
class TestDefaultTomlProvider {
    private val provider = { Source.from.toml }
    private val item = DefaultLoadersConfig.type

    @Test
    fun testProvider_onProvideSourceFromTomlFile_itShouldProvideAsAutoDetectedFileFormat() {
