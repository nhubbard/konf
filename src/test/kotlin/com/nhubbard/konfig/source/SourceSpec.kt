...
import com.nhubbard.konfig.NetworkBuffer
import com.nhubbard.konfig.Prefix
import com.nhubbard.konfig.SizeInBytes
import com.nhubbard.konfig.ValueNode
import com.nhubbard.konfig.name
import com.nhubbard.konfig.source.base.ValueSource
import com.nhubbard.konfig.source.base.asKVSource
import com.nhubbard.konfig.source.base.toHierarchical
        ...
        group("substitution operation") {
            on("doesn't contain any path variable") {
                ...
                it("should keep it unchanged") {
                    assertThat(source.tree.toHierarchical(), equalTo(map))
                }
            }
            ...
            on("contains integer path variable") {
                ...
                it("should substitute path variables") {
                    assertThat(
                        source.tree.toHierarchical(),
                        equalTo(mapOf("key1" to 1, "key2" to "b1", "key3" to 1))
                    )
                }
            }
            ...
            on("contains path variables in list") {
                ...
                it("should substitute path variables") {
                    assertThat(
                        source.tree.toHierarchical(),
                        equalTo(mapOf("top" to listOf(mapOf("key1" to "a", "key2" to "ba"))))
                    )
                }
            }
            ...
            on("contains escaped path variables") {
                ...
                it("should not substitute path variables") {
                    assertThat(
                        source.tree.toHierarchical(),
                        equalTo(mapOf("key1" to "a", "key2" to "b\${key1}"))
                    )
                }
            }
            ...
            on("contains multiple path variables") {
                ...
                it("should substitute path variables") {
                    assertThat(
                        source.tree.toHierarchical(),
                        equalTo(mapOf("key1" to "a", "key2" to "abc", "key3" to "c"))
                    )
                }
            }
            on("contains chained path variables") {
                ...
                it("should substitute path variables") {
                    assertThat(
                        source.tree.toHierarchical(),
                        equalTo(mapOf("key1" to "a", "key2" to "ab", "key3" to "abc"))
                    )
                }
            }
            on("contains nested path variables") {
                ...
                it("should substitute path variables") {
                    assertThat(
                        source.tree.toHierarchical(),
                        equalTo(mapOf("key1" to "a", "key2" to "ab", "key3" to "key1"))
                    )
                }
            }
            on("contains a path variable with default value") {
                ...
                it("should substitute path variables") {
                    assertThat(
                        source.tree.toHierarchical(),
                        equalTo(mapOf("key1" to "a", "key2" to "bc"))
                    )
                }
            }
            on("contains a path variable with key") {
                ...
                it("should substitute path variables") {
                    assertThat(
                        source.tree.toHierarchical(),
                        equalTo(mapOf("key1" to "a", "key2" to "aHelloWorld!"))
                    )
                }
            }
